<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="GununTatlisiAdmin.aspx.cs" Inherits="tatli_icecek2.GununTatlisiAdmin" %>
                ...
                <table class="auto-style7">
                    <tr>
                        ...
                        <td class="auto-style17">
                           <a href="TatliDuzenle.aspx?TatliID=<%#Eval("TatliID")%>"> <asp:Image ID="Image5" runat="server" CssClass="auto-style8" Height="30px" ImageUrl="~/ikonlar/clear-icon-png-11.jpg" Width="30px" /></a>
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
