...
namespace tatli_icecek2
{
    public partial class TarifOner : System.Web.UI.Page
    {
        ...
        {
            SqlCommand komut = new SqlCommand("insert into Tbl_Tarif(TatliTarifAd,TatliTarifMalzeme,TatliTarifYapilis,TatliTarifResim,TatliTarifSahip,TatliTarifSahipMail) values (@t1,@t2,@t3,@t4,@t5,@t6)", bgl.baglanti());
