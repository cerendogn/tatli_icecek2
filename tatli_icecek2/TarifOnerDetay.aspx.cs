...
namespace tatli_icecek2
{
    public partial class TarifOnerDetay : System.Web.UI.Page
    {
        ...
        {
            id = Request.QueryString["TatliTarifID"];

            if (Page.IsPostBack == false) { 
           

            SqlCommand komut = new SqlCommand("Select * From Tbl_Tarif where TatliTarifID=@p1", bgl.baglanti());
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand komut2 = new SqlCommand("insert into Tbl_Tatlilar(TatliAd, TatliMalzeme, TatliTarif, KategoriID) values (@p1, @p2, @p3, @p4)", bgl.baglanti());
